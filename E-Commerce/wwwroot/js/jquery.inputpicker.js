...
(function(factory) {
    ...
    function _renderTableHeader(input) {
        ...
        if(_set(input, 'headShow')){
            output += '<thead class="aqua-gradient"><tr>';
    ...
    function _dataRenderMultiple(input){
        ...
        if(data.length){
            ...
            output += "<thead class='peach-gradient'><tr><td colspan='" + fields.length + "' align='center' class=\"inputpicker-no-result\">No results.</td></thead></tr>";
        }
    ...
    function _dataRenderDefault(input) {
        ...
        // Draw table
        output += "<table class=\"table table-striped table-bordered small\">" ;
        ...
        if(data.length){
            ...
            output += "<thead class='peach-gradient'><tr><td colspan='" + fields.length + "' align='center'>No results.</td></thead></tr>";
        }
