...
namespace E_Commerce.Areas.Admin.Controllers
{
    ...
    public class NationalitiesController : Controller
    {
        ...
        public NationalitiesController(ApplicationDbContext context, IRecordCountService recordCountService)
        {
            _context = context;
    ...
    // GET: Admin/Nationalities
        ...
        var entityType = _context.Model.FindEntityType(typeof(Nationality));
        //var entityType = typeof(DTNationality);
        ...
        var gates = _context.Database.SqlQueryRaw<DTNationality>(sqlQry).ToList();

        DataTableResponse<DTNationality> response = new DataTableResponse<DTNationality>();
        ...
        // GET: Admin/Nationalities/Details/5
        ...
        // GET: Admin/Nationalities/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Admin/Nationalities/Create
        ...
        {
            nationality.created = DateTime.Now;
        nationality.created_by = Guid.Parse(User.Identity.Id());
        ...
        // GET: Admin/Nationalities/Edit/5
        ...
        // POST: Admin/Nationalities/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, Nationality nationality)
        {
            ...
            nationality.modified = DateTime.Now;
                nationality.modified_by = Guid.Parse(User.Identity.Id());
        ...
        // GET: Admin/Nationalities/Delete/5
        ...
        // POST: Admin/Nationalities/Delete/5
