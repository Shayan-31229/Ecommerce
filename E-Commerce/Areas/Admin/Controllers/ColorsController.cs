...
namespace E_Commerce.Areas.Admin.Controllers
{
    ...
    public class ColorsController : Controller
    {
        ...
        public ColorsController(ApplicationDbContext context, IRecordCountService recordCountService)
        {
            _context = context;
    ...
    // GET: Admin/Colors
        ...
        var entityType = _context.Model.FindEntityType(typeof(Color));
        //var entityType = typeof(DTColor);
        ...
        var gates = _context.Database.SqlQueryRaw<Color>(sqlQry).ToList();

        DataTableResponse<Color> response = new DataTableResponse<Color>();
        ...
        {
            color.created = DateTime.Now;
        color.created_by = Guid.Parse(User.Identity.Id());
        ...
        public async Task<IActionResult> Edit(int id, Color color)
        {
            ...
            color.modified = DateTime.Now;
                color.modified_by = Guid.Parse(User.Identity.Id());
